...
public class StringPairWritable implements WritableComparable<StringPairWritable> {
  ...
  public int compareTo(StringPairWritable other) {
    ...
    if(this.left != other.left){
    	if(this.left.length() > 0 && other.left.length() >0 ){
    		return (this.left.charAt(0) < other.left.charAt(0) ? -1:1);
    	}
    }else {
    	if(this.right.length() > 0 && other.right.length()>0){
    		return (this.right.charAt(0) < other.right.charAt(0) ? -1:1 );
    	}
    }
